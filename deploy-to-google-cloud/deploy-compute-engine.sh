...
# require set-variables.sh file
# the script provide the functions setvars and resetvars
# used within the script below
. ./set-variables.sh;

# execute function to update startup.sh file
setvars;
...
# execute function to revert changes make to startup.sh
resetvars;
